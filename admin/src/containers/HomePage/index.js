...
const SOCIAL_LINKS = [
  {
    name: 'GitHub',
    link: 'https://github.com/ludwigedward',
  },
  {
    name: 'Slack',
        ...
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
                ...
                <P>Ao lado você pode adicionar diferente cartegorias  e publishers para nosso maravilhoso Ecommerce</P>
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              <h2>Veja o Github do aluno e o Slack do criador do curso!</h2>
              <P style={{ marginTop: 7, marginBottom: 0 }}>Em caso de dúvida, consulte um dos links abaixo e entre em contato com o aluno ou com o professor do curso :)</P>
